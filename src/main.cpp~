...
*/
        ...
        data.position.x= translation(0);
        data.position.y= translation(1);
        data.position.z= translation(2);
        data.orientation.x= roll;
        data.orientation.y= pitch;
        data.orientation.z= yaw;
        data.orientation.w= translation.norm();
...
int main(int argc, char* argv[]) {
        ...
        ros::NodeHandle nt;
        chatter_pub = nt.advertise<geometry_msgs::Pose>("chatter", 1);
